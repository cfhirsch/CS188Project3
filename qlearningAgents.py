...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        nonLearning = (1 - self.alpha) * self.qValues[(state,action)]
        learning = (self.alpha * (reward + (self.discount * self.computeValueFromQValues(nextState))))
        self.qValues[(state,action)] = nonLearning + learning
